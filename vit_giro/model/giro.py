...
class vit_giro(osv.osv):
    ...
    _columns = {
        'name'          : fields.char('Number', help='Nomor Giro'),
        'due_date'      : fields.date('Due Date', help=''),
        'receive_date'  : fields.datetime('Receive Date', help=''),
        'clearing_date' : fields.datetime('Clearing Date', help=''),
        ...
        'giro_invoice_ids' : fields.one2many('vit.giro_invioce', 'giro_id'),
    ...
    def action_clearing(self, cr, uid, ids, context=None):
        ...
        for giro in self.browse(cr, uid, ids, context=context):
            for gi in giro.giro_invoice_ids:
                ...
                type = giro.type
                name = giro.name
                vid = voucher_obj.create_payment(cr, uid, invoice_id, partner_id, amount, journal_id, type, name, company_id,
                    context=context)
